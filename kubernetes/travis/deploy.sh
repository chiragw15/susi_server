#!/usr/bin/env bash
export DEPLOY_BRANCH=${DEPLOY_BRANCH:-kubernetes6}

if [ "$TRAVIS_PULL_REQUEST" != "false" -o "$TRAVIS_REPO_SLUG" != "chiragw15/susi_server" -o  "$TRAVIS_BRANCH" != "$DEPLOY_BRANCH" ]; then
